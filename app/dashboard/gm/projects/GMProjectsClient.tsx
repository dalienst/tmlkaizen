...
interface GMProjectsClientProps {
  projects: ProjectRow[];
...
export default function GMProjectsClient({
  projects,
  departments,
  coreValues,
          ...
          <tbody>
            ...
            {filtered.map((p) => (
              <tr key={p.id}>
                ...
                <td>
                  <Link href={`/dashboard/projects/${p.id}`} className="text-link" style={{ fontSize: "0.8125rem", textDecoration: "none" }}>
                    View Details
                  </Link>
                </td>
              </tr>
