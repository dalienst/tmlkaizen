...
CREATE TABLE "kaizen_projects" (
	...
	"core_value_ids" uuid[] DEFAULT '{}' NOT NULL,
...
ALTER TABLE "gm_locations" ADD CONSTRAINT "gm_locations_location_id_locations_id_fk" FOREIGN KEY ("location_id") REFERENCES "public"."locations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "department_code_unique" ON "departments" USING btree ("code");--> statement-breakpoint
